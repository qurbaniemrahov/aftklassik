...
(function(d) {
    ...
    function r(a, b, c) {
        var e = b + "-" + c;
        if (n[e]) {
            for (var a = a.cell(b, c).node(), c = n[e][0].parentNode.childNodes, b = [], d = 0, g = c.length; d < g; d++)
                b.push(c[d]);
            c = 0;
    ...
    d.extend(i.prototype, {
        ...
        _columnsVisiblity: function(a) {
            ...
            for (f = g.length; e < f; e++) {
                var k = g[e].columnIdx;
                "-" === j[k] && (!c[k].control && c[k].minWidth) && (s || 0 > h - c[k].minWidth ? (s = !0,
                j[k] = !1) : j[k] = !0,
                h -= c[k].minWidth)
            }
            g = !1;
            ...
            e.each(function(a, c) {
                for (var e = a.className.split(" "), f = !1, i = 0, m = e.length; i < m; i++) {
                    ...
                    d.each(b, function(a, b) {
                        ...
                        e && (f = !0,
                        e[2] === d[0] && e[3] === "-" + d[1] ? g(c, b.name, e[1], e[2] + e[3]) : e[2] === d[0] && !e[3] && g(c, b.name, e[1], e[2]))
                    })
                }
                f || (a.auto = !0)
            });
        ...
        _resize: function(a) {
            var b = this, c = this.s.dt, e = d(m).innerWidth(), f = this.c.breakpoints, g = f[0].name, j = this.s.columns, h, i = this.s.current.slice();
        ...
        listHiddenNodes: function() {
            return function(a, b, c) {
                ...
                d.each(c, function(b, c) {
                    c.hidden && (d("<li " + (c.className ? 'class="' + c.className + '"' : "") + ' data-dtr-index="' + c.columnIndex + '" data-dt-row="' + c.rowIndex + '" data-dt-column="' + c.columnIndex + '"><span class="dtr-title">' + c.title + "</span> </li>").append(d('<span class="dtr-data"/>').append(t(a, c.rowIndex, c.columnIndex))).appendTo(e),
                    f = !0)
                });
                return f ? e : !1
            }
