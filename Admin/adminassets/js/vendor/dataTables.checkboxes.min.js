...
!function(c) {
    ...
    x.prototype = {
        _constructor: function() {
            for (var e, t, c, s, o, l, a, n = this, d = n.s.dt, i = n.s.ctx, h = !1, u = !1, r = 0; r < i.aoColumns.length; r++) {
                i.aoColumns[r].checkboxes && (e = k(d.column(r).header()),
                h = !0,
                ...
                null === i.aoColumns[r].mRender && (t.render = function() {
                ...
                e.off(".dt"),
                null === i.sAjaxSource && ((c = d.cells("tr", r)).invalidate("data"),
                k(c.nodes()).addClass(t.className)),
                n.s.data[r] = {},
                n.s.dataDisabled[r] = {},
                n.s.columns.push(r),
                i.aoColumns[r].checkboxes.selectRow && (i._select ? u = !0 : i.aoColumns[r].checkboxes.selectRow = !1),
                i.aoColumns[r].checkboxes.selectAll && (e.data("html", e.html()),
                null !== i.aoColumns[r].checkboxes.selectAllRender && (s = "",
                k.isFunction(i.aoColumns[r].checkboxes.selectAllRender) ? s = i.aoColumns[r].checkboxes.selectAllRender() : "string" == typeof i.aoColumns[r].checkboxes.selectAllRender && (s = i.aoColumns[r].checkboxes.selectAllRender),
            ...
            u && (o.addClass("dt-checkboxes-select"),
            ...
            i._select.info && (d.select.info(!1),
        ...
        onDataTablesInit: function() {
            var o = this
              , e = o.s.dt
              , t = o.s.ctx;
            t.oFeatures.bServerSide || (t.oFeatures.bStateSave && o.updateState(),
        ...
        onDataTablesSelectDeselect: function(e, t, c) {
            var s, o, l = this, a = l.s.dt;
            l.s.ignoreSelect || "row" !== t || null !== (s = l.getSelectRowColIndex()) && (o = a.cells(c, s),
        ...
        onDataTablesXhr: function() {
            ...
            t.oFeatures.bStateSave && (c.loadState(),
        ...
        updateSelect: function(e, t) {
            var c = this.s.dt;
            this.s.ctx._select && (this.s.ignoreSelect = !0,
        ...
        updateCheckbox: function(e, t, c) {
            var s = this.s.ctx
              , o = e.nodes();
            o.length && (k("input.dt-checkboxes", o).not(":disabled").prop("checked", c),
        ...
        updateStateCheckboxes: function(e) {
            ...
            t.cells("tr", o.s.columns, e).every(function(e, t) {
                ...
                l.checkboxes.s.data[t].hasOwnProperty(c) && (o.updateCheckbox(this, t, !0),
        ...
        onClick: function(e, c) {
            ...
            o.aoColumns[d].checkboxes.selectRow ? setTimeout(function() {
                ...
                t !== c.checked && (s.updateCheckbox(n, d, t),
                s.updateSelectAll(d))
            }, 0) : (n.checkboxes.select(c.checked),
            e.stopPropagation())
        },
        ...
        loadState: function() {
            var c, s = this, e = s.s.dt, o = s.s.ctx;
            o.oFeatures.bStateSave && (c = e.state.loaded(),
            k.each(s.s.columns, function(e, t) {
        ...
        updateSelectAll: function(c) {
            var e, t, s, o, l, a, n, d, i, h, u, r = this, b = r.s.dt, x = r.s.ctx;
            ...
            if (e.aanFeatures.i) {
                ...
                if (null !== t) {
                    ...
                    k.each(e.aanFeatures.i, function(e, t) {
                        var c, s, o = k(t), l = k('<span class="select-info"/>');
                        c = "row",
                        s = d,
                        l.append(k('<span class="select-item"/>').append(n.i18n("select." + c + "s", {
                            _: "%d " + c + "s selected",
                            0: "",
                            1: "1 " + c + " selected"
                        }, s)));
        ...
        updateFixedColumn: function(e) {
            var t, c, s = this, o = s.s.dt, l = s.s.ctx;
            l._oFixedColumns && (t = l._oFixedColumns.s.iLeftColumns,
            c = l.aoColumns.length - l._oFixedColumns.s.iRightColumns - 1,
            (e < t || c < e) && (o.fixedColumns().update(),
            setTimeout(function() {
                k.each(s.s.columns, function(e, t) {
                    s.updateSelectAll(t)
                })
    ...
    t.registerPlural("columns().checkboxes.select()", "column().checkboxes.select()", function(i) {
        return void 0 === i && (i = !0),
        this.iterator("column-rows", function(c, s, e, t, o) {
            var l, a, n, d;
            c.aoColumns[s].checkboxes && (d = [],
    ...
    t.registerPlural("cells().checkboxes.select()", "cell().checkboxes.select()", function(l) {
        return void 0 === l && (l = !0),
        this.iterator("cell", function(e, t, c) {
            var s, o;
            ...
            e.checkboxes.isCellSelectable(c, o) && (e.checkboxes.updateData(s, c, l),
