...
(function(h) {
    ...
    function Ka(a, b, c, d) {
        var e = [], f = b.firstChild, g, j, i = 0, l, m = a.aoColumns, q = a._rowReadObject, d = d !== k ? d : q ? {} : [], u = function(a, b) {
            if ("string" === typeof a) {
                var c = a.indexOf("@");
            ...
            if (c === k || c === i)
                ...
                j && j._bAttrSrc ? (N(j.mData._)(d, l),
                u(j.mData.sort, a),
                u(j.mData.type, a),
                u(j.mData.filter, a)) : q ? (j._setter || (j._setter = N(j.mData)),
                j._setter(d, l)) : d[i] = l;
            i++
        };
        if (f)
    ...
    function Ja(a, b, c, d) {
        ...
        if (null === e.nTr) {
            ...
            for (q = a.aoColumns.length; m < q; m++) {
                ...
                g.push(i);
                if (k || (!c || l.mRender || l.mData !== m) && (!h.isPlainObject(l.mData) || l.mData._ !== m + ".display"))
        ...
        if (-1 !== h.inArray(!1, b))
            ...
            if (0 !== i.length) {
                ...
                for (j = j ? 0 : g; j < f; j++) {
                    ...
                    if (0 !== e) {
                        var G = d[c % e];
                        q._sRowStripe != G && (h(u).removeClass(q._sRowStripe).addClass(G),
                        q._sRowStripe = G)
                    }
        ...
        for (var f = a.sDom.split(""), g, j, i, l, m, q, k = 0; k < f.length; k++) {
            ...
            if ("<" == j) {
                ...
                if ("'" == l || '"' == l) {
                    ...
                    i.className = l[1]) : "#" == m.charAt(0) ? i.id = m.substr(1, m.length - 1) : i.className = m;
                    k += q
                }
                e.append(i);
                e = h(i)
    ...
    function ta(a, b, c) {
        ...
        a.fnServerData ? a.fnServerData.call(j, a.sAjaxSource, h.map(b, function(a, b) {
            ...
            url: g || a.sAjaxSource
        })) : "function" === typeof g ? a.jqXHR = g.call(j, b, i, a) : (a.jqXHR = h.ajax(h.extend(l, g)),
        g.data = f)
    }
    function nb(a) {
    ...
    function wb(a) {
        var b = a.aoColumns, c = b.length, d = a.oFeatures, e = a.oPreviousSearch, f = a.aoPreSearchCols, g, j = [], i, l, m, k = Y(a);
        g = a._iDisplayStart;
    ...
    function ma(a) {
        var b = a.oScroll, c = b.sX, d = b.sXInner, e = b.sY, b = b.iBarWidth, f = h(a.nScrollHead), g = f[0].style, j = f.children("div"), i = j[0].style, l = j.children("table"), j = a.nScrollBody, m = h(j), q = j.style, u = h(a.nScrollFoot).children("div"), n = u.children("table"), o = h(a.nTHead), p = h(a.nTable), r = p[0], t = r.style, s = a.nTFoot ? h(a.nTFoot) : null, U = a.oBrowser, V = U.bScrollOversize, Zb = C(a.aoColumns, "nTh"), Q, L, R, xa, v = [], x = [], y = [], z = [], A, B = function(a) {
            a = a.style;
            a.paddingTop = "0";
            a.paddingBottom = "0";
            a.borderTopWidth = "0";
    ...
    function Ha(a) {
        var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, f = d.sX, g = d.sXInner, j = c.length, i = na(a, "bVisible"), l = h("th", a.nTHead), m = b.getAttribute("width"), k = b.parentNode, u = !1, n, o, p = a.oBrowser, d = p.bScrollOversize;
        ...
        if (d || !u && !f && !e && j == W(a) && j == l.length)
            ...
            for (n = 0; n < i.length; n++)
                ...
                o.sWidthOrig && f && h(l[n]).append(h("<div/>").css({
                    width: o.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
            ...
            for (n = e = 0; n < i.length; n++)
                ...
                k = p.bBounding ? Math.ceil(l[n].getBoundingClientRect().width) : k.outerWidth(),
                e += k,
                c[i[n]].sWidth = w(k - g);
            b.style.width = w(e);
            o.remove()
    ...
    var n = function(a) {
        ...
        for (var e in n.ext.internal)
            e && (this[e] = Nb(e));
        this.each(function() {
            var e = {}, g = 1 < d ? Ya(e, a, !0) : a, j = 0, i, e = this.getAttribute("id"), l = !1, m = n.defaults, q = h(this);
            ...
            for (j = m.length; g < j; g++) {
                ...
                if ("table" === b)
                    ...
                    for (l = o.length; h < l; h++)
                        f = o[h],
                        f = "cell" === b ? c.call(t, m[g], f.row, f.column, g, h) : c.call(t, m[g], f, g, h, n),
                        f !== k && e.push(f)
                }
            }
            return e.length || d ? (a = new r(m,a ? e.concat.apply([], e) : e),
            b = a.selector,
            b.rows = s.rows,
            b.cols = s.cols,
            b.opts = s.opts,
    ...
    r.extend = function(a, b, c) {
        if (c.length && b && (b instanceof r || b.__dt_wrapper)) {
            ...
            for (e = c.length; d < e; d++)
                f = c[d],
                b[f.name] = "function" === f.type ? g(a, f.val, f) : "object" === f.type ? {} : f.val,
    ...
    r.register = o = function(a, b) {
        if (h.isArray(a))
            ...
            for (var e = a.split("."), f = Tb, g, j, c = 0, d = e.length; c < d; c++) {
                ...
                f.push(i));
                c === d - 1 ? (i.val = b,
                i.type = "function" === typeof b ? "function" : h.isPlainObject(b) ? "object" : "other") : f = j ? i.methodExt : i.propExt
            }
    }
    ;
    ...
    o("rows.add()", function(a) {
        var b = this.iterator("table", function(b) {
            ...
            for (g = a.length; f < g; f++)
                c = a[f],
                c.nodeName && "TR" === c.nodeName.toUpperCase() ? h.push(oa(b, c)[0]) : h.push(O(b, c));
            return h
        }, 1)
          , c = this.rows(-1);
        c.pop();
    ...
    o("cells()", function(a, b, c) {
        ...
        if (null === b || b === k)
            return this.iterator("table", function(b) {
                var d = a, e = cb(c), f = b.aoData, g = Da(b, e), j = Sb(ka(f, g, "anCells")), i = h([].concat.apply([], j)), l, n = b.aoColumns.length, o, s, r, t, w, v;
    ...
    , function(a) {
        if (a && !(a instanceof Date) && !ac.test(a))
            return null;
        var b = Date.parse(a);
