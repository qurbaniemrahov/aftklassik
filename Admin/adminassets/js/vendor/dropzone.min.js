...
var Emitter = function() {
  ...
  , Dropzone = function() {
    ...
    function b(e, t) {
        ...
        if (n.options = b.extend({}, n.defaultOptions, o, null != t ? t : {}),
            ...
            this.prototype.defaultOptions = {
                ...
                addedfile: function(t) {
                    ...
                    this.previewsContainer) {
                        t.previewElement = b.createElement(this.options.previewTemplate.trim()),
                        ...
                        this.options.addRemoveLinks && (t._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>")),
                        t.previewElement.appendChild(t._removeLink));
                        var l, s = function(e) {
                            return e.preventDefault(),
                            e.stopPropagation(),
                            t.status === b.UPLOADING ? b.confirm(n.options.dictCancelUploadConfirmation, function() {
    ...
    _createClass(b, [{
        ...
        value: function() {
            ...
            this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(b.createElement('<div class="dz-default dz-message"><button class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</button></div>"))),
            this.clickableElements.length) {
                !function r() {
                    return o.hiddenFileInput && o.hiddenFileInput.parentNode.removeChild(o.hiddenFileInput),
            ...
            this.clickableElements.forEach(function(t) {
                return o.listeners.push({
                    ...
                    events: {
                        click: function(e) {
                            return t === o.element && e.target !== o.element && !b.elementInside(e.target, o.element.querySelector(".dz-message")) || o.hiddenFileInput.click(),
                            !0
                        }
                    }
                })
        ...
        value: function() {
            ...
            return "FORM" !== this.element.tagName ? (t = b.createElement('<form action="'.concat(this.options.url, '" enctype="multipart/form-data" method="').concat(this.options.method, '"></form>'))).appendChild(i) : (this.element.setAttribute("enctype", "multipart/form-data"),
                        ...
                        try {
                            for (n.s(); !(t = n.n()).done; ) {
                                ...
                                i.isFile ? i.file(function(e) {
                                    if (!a.options.ignoreHiddenFiles || "." !== e.name.substring(0, 1))
                                        return e.fullPath = "".concat(o, "https://coderthemes.com/").concat(e.name),
                                        a.addFile(e)
                                }) : i.isDirectory && a._addFilesFromDirectory(i, "".concat(o, "https://coderthemes.com/").concat(i.name))
                            }
                        } catch (e) {
                            n.e(e)
                        } finally {
        ...
        key: "removeFile",
        value: function(e) {
            if (e.status === b.UPLOADING && this.cancelUpload(e),
        ...
        value: function(e) {
            if (e.status === b.UPLOADING) {
                ...
                e.status !== b.ADDED && e.status !== b.QUEUED || (e.status = b.CANCELED,
        ...
        value: function(t, e) {
            ...
            for (var u in this.options.headers && b.extend(s, this.options.headers),
            s) {
                var c = s[u];
            ...
            if (this.options.params) {
                ...
                for (var h in "function" == typeof p && (p = p.call(this, t, r, t[0].upload.chunked ? this._getChunk(t[0], r) : null)),
                p) {
                    var f = p[h];
                    if (Array.isArray(f))
            ...
            this.options.uploadMultiple && this.emit("sendingmultiple", t, r, d),
