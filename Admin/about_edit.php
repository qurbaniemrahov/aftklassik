...
<div class="wrapper">
    ...
    <div class="leftside-menu">
        ...
        <!-- LOGO -->
        <a target="_blank" href="https://proton.az" class="logo text-center logo-light">
                    <span class="logo-lg">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a href="./about_list.html" class="side-nav-link">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="./about_list">Haqqımızda</a></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="./about_update/3" method="POST"
                          enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="plbRc40QFgZdy2ZXj91W9TelqhbjwXP9Hfhhac3f">                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    <label for="img" class="form-label">Foto</label>
                                        ...
                                        <input type="hidden" name="old_img1" value="1678955300WhatsApp Image 2022-12-23 at 12.36.23.jpeg">
                                                                        <input type="file" name="img_1" id="img" class="form-control">
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="img" class="form-label">Foto</label>
                                        ...
                                        <input type="hidden" name="old_img2" value="1678955112WhatsApp Image 2022-12-23 at 12.36.51.jpeg">
                                                                        <input type="file" name="img_2" id="img" class="form-control">
                                </div>
