...
<html lang="en">
  <head>
    ...
    <!-- third party css -->
    <link
      href="./adminassets/css/vendor/dataTables.bootstrap4.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="./adminassets/css/vendor/responsive.bootstrap4.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="./adminassets/css/vendor/jquery-jvectormap-1.2.2.css"
      rel="stylesheet"
      type="text/css"
    />
    ...
    <!-- App css -->
    <link
      href="./adminassets/css/icons.min.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="./adminassets/css/app.min.css"
      rel="stylesheet"
      type="text/css"
      id="light-style"
    />
    <link
      href="./adminassets/css/app-dark.min.css"
      rel="stylesheet"
      type="text/css"
      id="dark-style"
    />
        ...
        <a target="_blank" href="" class="logo text-center logo-light">
          <span class="logo-lg">
            <img
              ...
              src="./adminassets/images/proton-logo_white.png"
              alt=""
              height="16"
            />
              ...
              <li class="dropdown notification-list">
                ...
                >
                  <span class="account-user-avatar">
                    <img
                      src="./adminassets/images/users/avatar-1.jpg"
                      alt="user-image"
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <img
                                src="./public/aboutimg1/1678955300WhatsApp Image 2022-12-23 at 12.36.23.jpeg"
                                title=""
                                class="rounded me-3"
                                height="48"
                              />
                            ...
                            <td class="table-action">
                              <a href="./about_edit.html" class="action-icon"
                                ><i class="fas fa-edit"></i
                              ></a>
                              <a href="about_delete/3" class="action-icon"
