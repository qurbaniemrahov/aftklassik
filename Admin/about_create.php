...
<div class="wrapper">
    ...
    <div class="leftside-menu">
        ...
        <a target="_blank" href="https://proton.az" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <!-- <img style="width:70%;height: 100%" src="./adminassets/images/logo.jpg"
                             alt="" height="16"> -->
                             <h2 style="color: #fff;">AFTKLASSIK</h2>
                    </span>
            <span class="logo-sm">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="wkHKtBHl9dRrNlJC7f1tpo2ljRuLOnA6IkjHKPZf">                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                            <label for="menu_type" class="form-label">Photo1</label>
                                                            <input type="file" name="img_1" id="menu_type" class="form-control" required>
                                            </div>

                                            <div class="mb-3">
                                                <label for="menu_type" class="form-label">Photo2</label>
                                                <input type="file" name="img_2" id="menu_type" class="form-control" required>
                                            </div>
